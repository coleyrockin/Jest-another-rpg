...
class Character {
  constructor(name = '', options = {}) {
    ...
    this.rng = rng;
    this.name = name;
    this.health = Number.isFinite(options.health) ? options.health : rng.nextInt(95, 104);
    this.maxHealth = Number.isFinite(options.maxHealth) ? options.maxHealth : this.health;
    this.strength = Number.isFinite(options.strength) ? options.strength : rng.nextInt(7, 11);
    this.agility = Number.isFinite(options.agility) ? options.agility : rng.nextInt(7, 11);
